...
public:
	...
	Button(float fX, float fY, int iTextureID, TextureLoader* texLoader2); // Creates button with given parameters
	void SetProperties(float fX, float fY, int iTextureID, TextureLoader* texLoader2);
